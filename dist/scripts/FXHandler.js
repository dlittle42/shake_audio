...
var FXHandler = function() {
	...
	function init(){
		...
		//renderComposer
		var renderTarget = new THREE.WebGLRenderTarget( screenW, screenH, renderTargetParameters );
		renderComposer = new THREE.EffectComposer( VizHandler.getRenderer(),renderTarget);
		var renderPass = new THREE.RenderPass( VizHandler.getScene(), VizHandler.getCamera() );
		var copyPass = new THREE.ShaderPass( THREE.CopyShader );
		var bloomPass = new THREE.BloomPass(3,12,2.0,512  );
		...
		var copyPass = new THREE.ShaderPass( THREE.CopyShader );
		var renderTarget2 = new THREE.WebGLRenderTarget( screenW/4, screenH/4, renderTargetParameters ); //1/2 res for performance
